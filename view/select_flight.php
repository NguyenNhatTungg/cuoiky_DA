...
<body>
    ...
    <div class="container">
        ...
        <div class="list-group mt-4">
            ...
            echo '<span class="me-2"><strong>Thời Gian:</strong> '.$departure_date.'</span>';
            $hasFlight = false;
            while ($row = mysqli_fetch_assoc($result)) {                        
                if($idDiemDi == $row['departure_airport'] && $idDiemDen == $row['arrival_airport'] && $departure_date == $row['departure_time'])
                {
                    $hasFlight = true;
                    ...
                    echo '<div class="d-flex align-items-center">';
                        ...
                        echo '<div class="ms-auto"><a href="enter_customer_info.php?one_way&diemDi='.$idDiemDi.'&airline='.$row['flight_number'].'&diemDen='.$idDiemDen.'&departure_date='.$departure_date.'&adults='.$adults_amount.'&children='.$children_amount.'" class="btn btn-primary">Đặt vé</a></div>';
                    echo '</div>';
                    echo '</tr>';
                    echo '</table>';
                    echo '</form>';
